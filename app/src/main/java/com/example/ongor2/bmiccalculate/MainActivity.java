package com.example.ongor2.bmiccalculate;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calBMI(){
        EditText textw = (EditText)findViewById(R.id.editText_weigth);
        EditText texth = (EditText)findViewById(R.id.editText_hrigth);
